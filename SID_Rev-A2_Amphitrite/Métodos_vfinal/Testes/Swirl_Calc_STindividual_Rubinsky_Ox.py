...
#Vazão mássica real
m_r = np.pi*(R_n*1e-3)**2*np.sqrt(2*Rho_p*Delta_P0*1e6)/np.sqrt((2-Phi_eq)/Phi_eq**3+Ksi*A_i**2/R_in**2)*1e3#np.pi*(R_n*1e-3)**2*np.sqrt(2*Rho_p*Delta_P0*1e6)/np.sqrt(1/Phi_eq**2+A_eq**2/(1-Phi_eq)+(Ksi*N_in)*A_i**2/C**2)*1000
...
for Delta_P in dPressure:
    ...
    #Vazão mássica real
    m_r = np.pi*(R_n*1e-3)**2*np.sqrt(2*Rho_p*Delta_P*1e6)/np.sqrt((2-Phi_eq)/Phi_eq**3+Ksi*A_i**2/R_in**2)*1e3#np.pi*(R_n*1e-3)**2*np.sqrt(2*Rho_p*Delta_P*1e6)/np.sqrt(1/Phi_eq**2+A_i**2/(1-Phi_eq)+(Ksi*N_in)*A_i**2/C**2)*1000
